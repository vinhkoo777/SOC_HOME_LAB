...
Tại đây. Ta chọn Option **Installer disc image file(iso)**. Và truyền đường dẫn iso image pfSense khi nãy đã tải. 
...
Ở đây tui sẽ để mặc định. Và nhấn **next** để tiếp tục.
...
Tại **LAN interfacface Assignment and Congiguration** chọn **Em1** ở đây là Network Adapter thứ hai của tui ở đây là **VMnet1 (Host-only)**
