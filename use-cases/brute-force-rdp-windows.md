...
```spl
index=* host="DESKTOP-GDHTT5E" source="WinEventLog:Security" "<EventID>4625</EventID>" "<Data Name='LogonType'>3</Data>" OR "<Data Name='LogonType'>10</Data>"
...
```spl
index=* host="DESKTOP-GDHTT5E" source="WinEventLog:Security" "<EventID>4624</EventID>" "<Data Name='LogonType'>3</Data>" OR "<Data Name='LogonType'>10</Data>"
| rex field=_raw "<Data Name='IpAddress'>(?<src_ip>\d+\.\d+\.\d+\.\d+)</Data>"
| rex field=_raw "<Data Name='TargetUserName'>(?<user>[a-zA-Z0-9._-]+)</Data>"
| stats count by src_ip user
| sort - count
